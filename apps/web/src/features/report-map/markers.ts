...
export { isPublicStatus as isMapStatus, PUBLIC_STATUSES as MAP_STATUSES, type PublicStatus as MapStatus } from '@ravonroad/shared-types'
...
export const MARKER_LOOK: Record<PublicStatus, MarkerLook> = {
