...
export function HomePage() {
  ...
  return (
    // `lg:min-h-0` обязателен: без него строка сетки растёт по содержимому, карта
    // с `h-full` берёт эту выросшую высоту за сто процентов и уезжает под подвал —
    // вместе с переключателем «карта / список» и кнопкой геопозиции, которые лежат
    // в её нижних углах и просто исчезали с экрана.
    <div className="flex flex-1 flex-col lg:grid lg:min-h-0 lg:grid-cols-[1fr_420px]">
