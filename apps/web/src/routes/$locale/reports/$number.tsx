...
export function ReportDetailPage() {
  ...
  return (
    // Ноутбук: карточка заявки и колонка «где это» стоят колонкой по центру, а не во всю
    // ширину экрана (Desktop C › экран 3). 1440, а не 1120: при 1120 на широком мониторе
    // фотографии «до» и «после» ужимались до трети экрана, а по бокам оставалось поле
    // шире самой карточки.
    //
    // Верхнее поле — своё: под шапкой строка с номером начиналась сразу за её линией
    // и читалась как часть шапки, а не как начало страницы.
