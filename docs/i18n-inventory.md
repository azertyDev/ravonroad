...
| Ключ | Oʻzbekcha | Русский | Статус |
| --- | --- | --- | --- |
| `home.title` | Chuqurni belgilang. Brigada tuzatadi. | Отметьте яму. Бригада починит. | правка (было «Ямы на дорогах Ташкента» — существительное вместо глагола) |
| `home.lead` | Davlat organlari ishtirok etmaydi. Faqat siz va volontyorlar. | Государство не участвует. Только вы и волонтёры. | правка |
...
| `home.goalLabel` | maqsad · 10 000 | цель · 10 000 | правка |
